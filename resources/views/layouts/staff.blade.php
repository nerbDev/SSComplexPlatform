...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        .search-box kbd{
            margin-left:auto;font-size:10px;background:rgba(255,255,255,.08);
            padding:2px 6px;border-radius:5px;color:#c7d6cf;
        }
        ...
        .sidebar-close{
            ...
            border:none;color:#eaf6f0;align-items:center;justify-content:center;
        ...
        .trend{font-size:12px;font-weight:700;display:inline-flex;align-items:center;gap:4px;}
